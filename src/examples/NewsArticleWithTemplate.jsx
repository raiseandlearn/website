...
/**
 * Example: NewsArticle component using EventImageTemplate
 *
 * This demonstrates how to replace static event images with dynamic templates
 * that can be customized with different text, months, and color themes.
 */
const NewsArticleWithTemplate = () => {
  const { id } = useParams();
    ...
    <div className="news-article-page">
      ...
      <main className="article-main">
        <div className="article-container">
          ...
          {/* Featured Image - NOW USING TEMPLATE */}
...
export default NewsArticleWithTemplate;
